...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 py-3.5 bg-black/80 backdrop-blur-xl border-b border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.9)] transition-all">
